...
class _TexEmissiveSocket(_TexColorSocket[Tuple3F]):
...
class _TexSpecularSocket(_TextureSocket):
    ...
    factor = DictProperty[Tuple4F]("specular")
...
class MaterialStage(_BaseDict):
    ...
    class _Detail(_BaseDict):
        ...
        scale = DictProperty[Tuple2F]("detailScale")
    ...
    class _Animation(_BaseDict):
        ...
        scroll_direction = DictProperty[Tuple2F]("scrollDir")
        rot_speed = DictProperty[float]("rotSpeed")
        rot_pivot_offset = DictProperty[Tuple2F]("rotPivotOffset")
    ...
    def __init__(self, dict: dict[str, object]):
        ...
        def newcs[T:_TextureSocket](map: str, value: str, uv: str, instance: str, vertex: str, type: type[T] = _TexColorSocket[Tuple4F]):
