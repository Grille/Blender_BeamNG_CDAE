...
from ..beamng.cdae.io.dae_asset import DaeAsset
...
class ExportBase(PresetOperator, ExportHelper):
    ...
    limit_precision_enabled: bool
    limit_precision_dp: int
    asset_file_enabled: bool

    use_transforms: bool
    compression_enabled: bool
    build_mode: str

    geo_apply_scale: bool
    geo_uv_mode: str
    geo_uv0: str
    geo_uv1: str
    geo_eval: str
    ...
    def execute(self, context):
        ...
        builder.tree.build_mode = CdaeTreeBuildMode(build_mode)

        mesh_builder = builder.mesh_builder
        mesh_builder.split_draw_regions = self.file_format == FileFormat.CDAE
        mesh_builder.eval_mode = MeshDataEvalMode(self.geo_eval)
        ...
        match self.file_format:
            case FileFormat.DAE:
                ...
                if self.asset_file_enabled:
                    DaeAsset.set_file(builder.cdae, filepath)
